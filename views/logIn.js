...
import { StyleSheet, Text, View, ImageBackground,SafeAreaView,ScrollView,TextInput, Pressable } from 'react-native';
    ...
    <View style={styles.containerLogIn}>
      ...
      <ImageBackground source={require('../assets/images/fondo.png')}
              ...
              <View style={styles.title}>
                <Text style = {{ fontSize: '30px', fontWeight: 'bold', alignSelf: 'center', justifyContent: 'center'}}>Dinner's Ready</Text>
              </View>
